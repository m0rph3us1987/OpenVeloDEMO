...
--
-- Recipe rows are NOT seeded here. The TypeScript seed in
-- apps/api/src/seed.ts owns the recipe catalog and is invoked on API
-- startup (when the Recipe table is empty) and on POST /api/admin/reset.
